<style>
      ...
      #okno {
        ...
        text-align: center;
        padding: 15px;
        border: 1px double rgba(255, 255, 0, 0.958);
        border-radius: 10px;
        position: absolute;
        top: 0;
        right: 0;
...
<div class="log">
Ваш регоин: <select name="region" id="input-select">
...
<a href="#" id="main">
      <div id="okno">
	  GeForce GTX 1050TI <br> <img src="izo\video\GeForceGTX1050TI.png" width="100" height = "100" ><br>
